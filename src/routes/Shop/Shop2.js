...
const Shop2 = () =>{
    ...
    const getProduct =async() =>{
        ...
        await Axios.get(uri)
        .then((response)=>{
            return response.data.filter((product)=>product.itemStatus==="판매 중"&&product.category==="CATEGORY2")
        })
            ...
            <div className="product_content">
                <div className='category_list'>
                    ...
                    <ul>
                        ...
                        <li>
                            <a id="selected" href="/category/2">CATEGORY2</a>
                        </li>
                        <li>
                            <a href="/category/3">CATEGORY3</a>
                        </li>
                    </ul>
                </div>
