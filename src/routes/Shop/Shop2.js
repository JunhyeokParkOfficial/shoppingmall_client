...
const Shop2 = () =>{
    ...
    const getProduct =() =>{
      axios.get(uri)
      .then((response)=>{
        return response.data.filter((product)=>product.item_status==="판매 중"&&product.category==="CATEGORY2")}).then((data)=>setData(data));
    }
    useEffect(()=>{
        getProduct();
    },[]);
            ...
            <div className="product_content">
                <div className='category_list'>
                    ...
                    <ul>
                        ...
                        <li>
                            <Link id="selected" to="/category/2">CATEGORY2</Link>
                        </li>
                        <li>
